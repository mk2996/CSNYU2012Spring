    ...
    'Ext.app.ScatterPortlet',
    {
                    ...
                    series:[
                        {
                            ...
                            tips:{
                                ...
                                renderer:function (storeItem, item) {
                                    ...
                                    if (totalClientView == true) {
                                        if(storeItem.get('name')==''){
                                            this.setTitle("General View");
                                        } else {
                                            this.setTitle("Double Click to View Details");
                                        }
                            ...
                            listeners:{
                                itemmouseup:function (a, b, c, d, e) {
                                    if (totalClientView == true && a.storeItem.data.name!='') {
        ...
        createHandler:function (fieldName) {
            return function (sprite, record, attr, index, store) {
                ...
                } else if (fieldname == 'REVENUE'
                    || fieldname == 'TRADE_VOLUME') {
                    if (value > benchMark_val) {
                        circleColor = 1;
                ...
                var color = [ 'rgb(255, 0, 0)', 'rgb(0, 0, 255)',
                    'rgb(0, 255, 0)', 'rgb(255, 255, 0)', 'rgb(255,255,255)' ][circleColor];
                return Ext.apply(attr, {
                    radius:fieldValue,
                    fill:color
                });
...
updateScatterStore = function () {
    ...
    var xMax = 80, xMin = 0, yMax = 100, yMin = 0, xpos, ypos;
...
paintScatterChart = function (isTotal) {
        var fieldSetScatter = Ext.getCmp('scatter.chart');
        var scatterChart = Ext.getCmp('scatterChartId');
...
//        fieldSetScatter.removeAll(true);
        scatterChart = Ext.getCmp('scatter_porlet_widget').getScatterChart(
            isTotal);
        fieldSetScatter.add(scatterChart);
};
